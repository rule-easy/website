    ...
    return (
        <div>
            <button onClick={props.onClick} type="submit"
                className="flex items-center justify-center border border-transparent bg-indigo-600 px-4 py-1 text-base font-medium text-indigo-100 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 disabled:bg-gray-800 disabled:cursor-not-allowed" disabled={props.disabled}>
                {props.licon &&
