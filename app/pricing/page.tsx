                    ...
                    <div className="relative pt-32 pb-10 md:pt-40 md:pb-16">
                        ...
                        <div className="flex flex-col divide-y divide-gray-700" >
                            ...
                            <div className="grid grid-cols-3 text-left md:mb-8">
                                <div className="flex flex-col mr-8">
                                    <div className="flex flex-row justify-left">
                                        ...
                                        <span className="inline-block align-text-top text-gray-200"> No PII data required to start</span>
                                    </div>
                                    <br></br>
                                    <div className="flex flex-row justify-left">
                                        <FontAwesomeIcon icon={faBoltLightning} className="pr-2 text-indigo-600" />
                                        <span className="inline-block align-text-top text-gray-200"> Integrate in Minutes</span>
                                    </div>
                                    <br></br>
                                    <div className="flex flex-row justify-left">
                                        <FontAwesomeIcon icon={faBan} className="pr-2 text-indigo-600" />
                                        <span className="inline-block align-text-top text-gray-200"> Real-Time Intelligence</span>
                                    </div>
                                </div>
                                <div className="flex flex-col mr-4">
                                    <div className='h2 mb-4 text-custom-primary text-2xl'> Free </div>
                                    <span className="inline-block align-text-top text-gray-200"> Ideal for biz that are just starting up</span>
                                    <span className="inline-block align-text-top text-gray-600"> No PII data required to start</span>
                                    <br></br>
                                    <button type="submit" className="w-full flex items-center justify-center rounded-md border border-transparent bg-indigo-600 px-8 py-3 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 ">Get started <FontAwesomeIcon icon={faArrowRight} color="#FFF" className="pl-4" /></button>
                                </div>
                                <div className="flex flex-col mr-4">
                                    ...
                                    <span className="inline-block align-text-top text-gray-600"> No PII data required to start</span>
                                    <br></br>
                                    <button type="submit" className="w-full flex items-center justify-center rounded-md border border-transparent bg-indigo-600 px-8 py-3 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">Get pricing <FontAwesomeIcon icon={faArrowRight} color="#FFF" className="pl-4" /></button>
                                </div>
                            </div>
                            {/* Table row-1 */}
                            ...
                            <div className="grid grid-cols-3 text-left">
                                ...
                                <span className="inline-block text-center font-semibold mt-3 mb-3">Basic</span>
                                <span className="inline-block text-center font-semibold mt-3 mb-3">Advanced</span>
                            </div>
                            {/* Table row-3 */}
                            <div className="grid grid-cols-3 text-left">
                            ...
                            <div className="grid grid-cols-3 text-left">
                                ...
                                <span className="inline-block text-center font-semibold mt-3 mb-3">5 per week</span>
                                <span className="inline-block text-center font-semibold mt-3 mb-3">Unlimited</span>
                            </div>
                            {/* Table row-4 */}
                            <div className="grid grid-cols-3 text-left">
                                <span className="inline-block text-gray-500 text-left font-semibold mt-3 mb-3">ML data size</span>
                                <span className="inline-block text-center font-semibold mt-3 mb-3">Upto 50 MB</span>
                                <span className="inline-block text-center font-semibold mt-3 mb-3">Upto 1GB</span>
                            </div>
                            ...
                            <div className="grid grid-cols-3 text-left">
                                ...
                                <span className="inline-block text-center font-semibold mt-3 mb-3">7 days</span>
                                <span className="inline-block text-center font-semibold mt-3 mb-3">60 days</span>
                            </div>
                            <div className="grid grid-cols-3 text-left">
                            ...
                            <div className="grid grid-cols-3 text-left">
                                ...
                                <span className="inline-block text-center font-semibold mt-3 mb-3">Upto 5</span>
                                <span className="inline-block text-center font-semibold mt-3 mb-3">Upto 50</span>
                            </div>
                            <div className="grid grid-cols-3 text-left">
                                <span className="inline-block text-gray-500 text-left font-semibold mt-3 mb-3">Free rule evaluation</span>
                                <span className="inline-block text-center font-semibold mt-3 mb-3">Upto 5K requests</span>
                                <span className="inline-block text-center font-semibold mt-3 mb-3">Upto 50K requests</span>
                            </div>
                            <div className="grid grid-cols-3">
                                <span className="inline-block text-gray-500 text-left font-semibold mt-3 mb-3">On-demand rule evaluation</span>
                                <span className="inline-block text-center font-semibold mt-3 mb-3">$25 per 10K req</span>
                            ...
                            {/* Table row-6 */}
                            <div className="grid grid-cols-3 text-left">
                                <span className="inline-block text-gray-500 text-left font-semibold mt-3 mb-3">Number of users</span>
                                <span className="inline-block text-center font-semibold mt-3 mb-3">3</span>
                                <span className="inline-block text-center font-semibold mt-3 mb-3">25</span>
                            </div>
                        </div>
                    </div>
                </div>
