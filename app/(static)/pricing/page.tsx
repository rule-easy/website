...
import {
    faArrowRight, faBan, faBoltLightning, faCheckCircle, faCircleXmark, faEnvelope, faPhone
                    ...
                    <div className="relative pt-32 pb-10 md:pt-40 md:pb-16">
                        ...
                        <div className="flex flex-col divide-y divide-gray-700" >
                            ...
                            <div className="grid grid-cols-3 text-left">
                                ...
                                <span className="inline-block text-center font-semibold mt-3 mb-3 text-indigo-100">Upto 10K requests / month</span>
                                <span className="inline-block text-center font-semibold mt-3 mb-3 text-indigo-100">Upto 25K requests / month</span>
                            </div>
                            <div className="grid grid-cols-3">
                                <span className="inline-block text-gray-500 text-left font-semibold mt-3 mb-3">Paid rule evaluation</span>
                                <span className="inline-block text-center font-semibold mt-3 mb-3 text-indigo-100">$30 per 10K requests</span>
                            ...
                            <div className="grid grid-cols-3 text-left">
                                ...
                                <span className="inline-block text-center font-semibold mt-3 mb-3 text-indigo-100">3 days</span>
                            ...
                            <div className="grid grid-cols-3 text-left">
                                <span className="inline-block text-gray-500 text-left font-semibold mt-3 mb-3">Support</span>
                                <span className="inline-block text-center font-semibold mt-3 mb-3"><FontAwesomeIcon icon={faEnvelope} size="xl" className="text-custom-green" /></span>
                                <span className="inline-block text-center font-semibold mt-3 mb-3"><FontAwesomeIcon icon={faPhone} size="xl" className="text-custom-green" /></span>
                            </div>

                            {/* Advanced features */}
                            <div className="grid grid-cols-1">
                                <span className="inline-block text-center font-bold mt-3 mb-3 text-indigo-600">Advanced features</span>
                            </div>
                            <div className="grid grid-cols-3 text-left">
                            ...
                            <div className="grid grid-cols-3 text-left">
                                <span className="inline-block text-gray-500 text-left font-semibold mt-3 mb-3"> Supported ML models</span>
                            ...
                            <div className="grid grid-cols-3 text-left">
                                <span className="inline-block text-gray-500 text-left font-semibold mt-3 mb-3">ML training data size</span>
                            ...
                            <div className="grid grid-cols-3 text-left">
                                <span className="inline-block text-gray-500 text-left font-semibold mt-3 mb-3">Max number of features</span>
                                <span className="inline-block text-center font-semibold mt-3 mb-3 text-indigo-100">10</span>
                                <span className="inline-block text-center font-semibold mt-3 mb-3 text-indigo-100">100</span>
                            </div>
                            ...
                            {/* Table row-6 */}
                            <div className="grid grid-cols-3 text-left">
                                <span className="inline-block text-gray-500 text-left font-semibold mt-3 mb-3">Core features</span>
                                <span className="inline-block text-center font-semibold mt-3 mb-3"><FontAwesomeIcon icon={faCheckCircle} size="xl" className="text-custom-green" /></span>
                                <span className="inline-block text-center font-semibold mt-3 mb-3"><FontAwesomeIcon icon={faCheckCircle} size="xl" className="text-custom-green" /></span>
                            </div>
                            <div className="grid grid-cols-3 text-left">
                                <span className="inline-block text-gray-500 text-left font-semibold mt-3 mb-3">Total free users</span>
                            ...
                            <div className="grid grid-cols-3 text-left">
                                <span className="inline-block text-gray-500 text-left font-semibold mt-3 mb-3">Paid user</span>
                                <span className="inline-block text-center font-semibold mt-3 mb-3 text-indigo-100">$20 / user per month</span>
                                <span className="inline-block text-center font-semibold mt-3 mb-3 text-indigo-100"> </span>
                            </div>
                            <div className="grid grid-cols-3 text-left">
